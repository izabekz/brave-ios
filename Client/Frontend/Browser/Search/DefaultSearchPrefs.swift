...
private struct SearchPluginList: Codable {
    ...
    let regionOverrides: [String: SearchLocale]
    ...
    init(from decoder: Decoder) throws {
        ...
        regionOverrides = try container.decode([String: SearchLocale].self, forKey: .regionOverrides)
    }
}
